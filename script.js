...
const _glbOpaqueShaderPlane = new Cesium.CustomShader({
    ...
    fragmentShaderText: [
        ...
        '',
        '    // NOTE: a warm orange "cockpit instrument glow" used to be added',
        '    // here via u_cockpitAmbient, but since it applied to every',
        '    // fragment of the whole mesh (not just instrument geometry) it',
        '    // bled across the entire cockpit/cabin and made the first-person',
        '    // view look orange-tinted. Disabled per design — cockpit now',
        '    // only gets the same neutral night base glow as the rest of the',
        '    // aircraft, above.',
        '',
