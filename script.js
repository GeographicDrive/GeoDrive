...
function updateCesiumCamera() {
    ...
    // Ground vehicles use a fixed approximate driver eye height (this app
    // uses flat/sea-level terrain by default, same simplification the rest
    // of the physics already makes). The plane uses its real, simulated
    // flight altitude.
    ...
    // anchored at ground level (0m); the plane is anchored at its own
    // flight altitude (it has no ground reference to sit on).
    const anchorHeight = isPlane ? flight.alt * 0.3048 : 0;
